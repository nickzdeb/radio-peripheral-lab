...
#/tools/Xilinx/Vivado/2024.2/bin/vivado -nolog -nojournal -mode batch -source ./tcl/make_project.tcl
...
#/tools/Xilinx/Vivado/2024.2/bin/vivado -nolog -nojournal -mode batch -source ./tcl/impl.tcl
